...
public class FileDownloadUtil {
    ...
    public static void play(String url, String oldName, HttpServletRequest request,
                            HttpServletResponse response, String range) {
        // 文件位置
        File music = new File(url);
        // 开始下载位置
        long startByte = 0;
        // 结束下载位置
        ...
        response.setHeader("Content-Disposition", "inline;filename=".concat(oldName));
